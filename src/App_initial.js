...
window.location.href = "/dashboard";
  ...
  return (
    <div className="bg-white text-gray-800">
      <section className="flex justify-between items-center p-4 bg-orange-600 text-white">
...
<section className="py-12 bg-white">
    <div className="App">
      {/* Replace this with a route switch if using React Router */}
      <AdminDashboard />
    </div>
  </section>
    </div>
